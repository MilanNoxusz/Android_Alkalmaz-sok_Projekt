...
public class visitedCountriesFragment extends Fragment {
     ...
     * @return A new instance of fragment visitedCountriesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static visitedCountriesFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.visited_countries_layout, container, false);
    }
    @Override
    public void onViewCreated(@androidx.annotation.NonNull android.view.View view, @androidx.annotation.Nullable android.os.Bundle savedInstanceState) {
        ...
        android.widget.Button backBtn = view.findViewById(R.id.back_button_visited);
